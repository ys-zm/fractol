...
/*   Updated: 2023/03/06 16:23:35 by yzaim         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void    draw(t_fractol* frac)
{
    ...
    {
        x = 0;
        im = pix_to_coord_y(frac->y_ends.start, frac->y_ends.end, y, frac) + frac->pix.y;
        while (x < frac->win_size.width)
        {
            re = pix_to_coord_x(frac->x_ends.start, frac->x_ends.end, x, frac) + frac->pix.x;
